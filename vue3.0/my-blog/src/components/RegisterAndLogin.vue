<template>
  <div>
    <el-dialog title="登陆" :visible="dialogVisible" @close="cancel">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="handleAuthor">Github 授权登陆</el-button>
        <el-button type="primary" @click="handleOk">登陆</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default class RegisterAndLogin extends Vue {
  ...
  @Prop() private handleFlag:string
    ...
    private handleAuthor():void {
      ...
      window.location.href = `https://github.com/login/oauth/authorize?client_id=4b37b95dda2dc34c1316&redirect_url=https://localhost:8080/${preventHistory.name}`
    }
